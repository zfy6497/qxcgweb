...
export const pcRouter = {
  ...
  children: [
    ...
    { path: '/classify1/:id', title: { i18n: 'classify1' }, name: 'classify_index1', component: resolve => { require(['@/views/Classify/Index.vue'], resolve) } },
    { path: '/classify2/:id', title: { i18n: 'classify2' }, name: 'classify_index2', component: resolve => { require(['@/views/Classify/Index.vue'], resolve) } },
    { path: '/classify3/:id', title: { i18n: 'classify3' }, name: 'classify_index3', component: resolve => { require(['@/views/Classify/Index.vue'], resolve) } },
    { path: '/classify4/:id', title: { i18n: 'classify4' }, name: 'classify_index4', component: resolve => { require(['@/views/Classify/Index.vue'], resolve) } },
